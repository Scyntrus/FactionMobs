    ...
    public static void checkVersion() throws VersionException {
        ...
        try {
            ...
            if (tmpMcpcClass != null) {
                if (tmpMcpcClass.getResourceAsStream("/mappings/v1_9_R1/cb2numpkg.srg") != null) {
        ...
        throw new VersionException("You are running an unsupported version of CraftBukkit (Requires: v1_9_R1, Found:"+foundVersion+"). Please download a newer version. FactionMobs will not be enabled.");
    }
}
