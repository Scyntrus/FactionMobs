...
public class VersionManager {
    ...
    public static void checkVersion() throws VersionException {
        if (Package.getPackage("org.bukkit.craftbukkit.v1_8_R3") != null) {
            return;
        }
        ...
        throw new VersionException("You are running an unsupported version of CraftBukkit (Requires: v1_8_R3, Found:"+foundVersion+"). Please download a newer version. FactionMobs will not be enabled.");
    }
}
