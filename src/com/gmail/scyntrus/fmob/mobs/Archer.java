...
import net.minecraft.server.v1_13_R1.PathfinderGoalBowShoot;
...
public class Archer extends EntitySkeleton implements FactionMob {
    ...
    @Override
    public void a(EntityLiving entityliving, float f) { //TODO: Update name on version change (E: EntitySkeletonAbstract.attackEntityWithRangedAttack)
        if (damage>0) {
