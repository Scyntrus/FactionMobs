...
class Kingdom extends Faction {
    ...
    public com.songoda.kingdoms.constants.kingdom.Kingdom k;

    public Kingdom(com.songoda.kingdoms.constants.kingdom.Kingdom faction) {
        this.k = faction;
    }

    public Kingdom(Object faction) {
        this.k = (com.songoda.kingdoms.constants.kingdom.Kingdom) faction;
    }
    ...
    public void processMob(FactionMob mob) {
        mob.getEntity().getBukkitEntity()
                .setMetadata("kingdom+" + this.getName(), new FixedMetadataValue(FactionMobs.instance, true));
    }
